...
const Profile = () => {
    ...
    const handleCancel = () => {
        setIsEditing(false);
        // You might want to refetch data here to reset any changes
    };
                            ...
                            <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
                                ...
                                <div className="text-center md:text-left">
                                    ...
                                    <div className="flex items-center justify-center md:justify-start space-x-2 text-blue-100">
                                        ...
                                        <span className="capitalize">{formData.userType}</span>
                                        <span>•</span>
                                        <span>{formData.userType === 'student' ? formData.studentId : formData.employeeId}</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                {!isEditing ? (
                                    ...
                                    <div className="flex space-x-2">
                                        <button
                                            onClick={handleSave}
                                            disabled={saving}
                                            className="bg-green-500 hover:bg-green-600 disabled:bg-green-400 text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-all duration-200"
                                        >
                                            <Save className="w-4 h-4" />
                                        ...
                                        <button
                                            onClick={handleCancel}
                                            disabled={saving}
                                            className="bg-white/20 hover:bg-white/30 disabled:bg-white/10 text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-all duration-200"
                                        >
                                            <X className="w-4 h-4" />
                                            <span>Cancel</span>
                                        </button>
                            ...
                            {isEditing && (
                                <div className="mt-8 flex flex-col sm:flex-row gap-4 md:hidden">
                                    ...
                                    <button
                                        onClick={handleCancel}
                                        disabled={saving}
                                        className="w-full bg-gray-500 hover:bg-gray-600 text-white py-3 px-6 rounded-lg font-medium transition-all duration-200 flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        <X className="w-5 h-5" />
                                        <span>Cancel</span>
                                    </button>
